...
Make sure to checkout https://github.com/pbrezina/sssd-test-suite_dir

run-test-suite_dir.sh SSSD-SOURCE-DIR TEST-suite_dir-DIR ARTIFACTS-DIR CONFIG-FILE
  SSSD-SOURCE-DIR Path to SSSD source directory.
  TEST-suite_dir-DIR  Path to sssd-test-suite_dir directory.
...
start-guest() {
    run-vagrant destroy $1
    success-or-die $? "Unable to destroy guest: $1"
